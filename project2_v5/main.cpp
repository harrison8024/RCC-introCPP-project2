 ...
 * Created on January 21, 2019, 04:30 PM
 * Purpose: Project 1 Blackjack V5 - added betting system, and display layout
 */
...
public:
    ...
    //parameters take in the deck container and the number of poker deck wish to create
...
int main(int argc, char** argv) {
    ...
    system("clear");
    while(input != 'x'){
        cout << endl << "You have " << chips << " chips." << endl;
        cout << endl << "Place Your bets or enter 'x' to exit. Choose one of the following letter." << endl;
        ...
        bet = game.plcBet(input); //bet is placed
        if(bet > chips){
